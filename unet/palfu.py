...
# pthfile = r'/media/ubuntu/D/code/Pytorch-UNet-master/checkpoints/CP_epoch5.pth'
# net= unet_model.UNet(n_channels=1, n_classes=1, bilinear=True)
...
#     m_1 = torch.sigmoid(m1)
#     m_2 = torch.sigmoid(m2)
#     weigh1 = torch.ones_like(m_1) * 0.6
#     weigh2 = torch.ones_like(m_1) * 0.4
    
#     m_1 = m_1 / (m_1 + m_2)
#     m_1 = torch.where(m_1 > 0.6, weigh1, m_1)
#     m_1 = torch.where(m_1 < 0.4, weigh2, m_1)
#     m_2 = torch.where(m_2 > 0.6, weigh1, m_2)  
#     m_2 = torch.where(m_2 < 0.4, weigh2, m_2)  
#     m_2 = m_2 / (m_1 + m_2)
#     m_1 = ((abs(m_1 - 0.5)*10 )**0.5)/10 + 0.5
#     m_2 = 1 - m_1     
#     return m_1, m_2
